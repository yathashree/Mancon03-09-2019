...
public class ChecklistTypes extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
...
Button checklisttypesubmit,checklisttypecancel;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.checklisttypes);
...
Intent intent=new Intent(getApplicationContext(),DayChecklistSummary.class);
startActivity(intent);
...

        {
            ...
            public void onClick (View v){
                ...
                PopupMenu popup = new PopupMenu(ChecklistTypes.this, img_menu);
        ...
        navMenuView.addItemDecoration(new DividerItemDecoration(ChecklistTypes.this, DividerItemDecoration.VERTICAL));
        navigationView2.setNavigationItemSelectedListener(this);

        dataList = (ListView) findViewById(R.id.list);
//        getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor("#2196f3")));

        mAdapter = new MyCustomAdapter(ChecklistTypes.this);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.schedule) {
            Intent schedule = new Intent(ChecklistTypes.this, HomeActivityMenu.class);
            startActivity(schedule);
        } else if (id == R.id.dashboard) {
            Intent dashboard = new Intent(ChecklistTypes.this, DashboradActivity.class);
            startActivity(dashboard);
        } else if (id == R.id.client_Reports) {
            Intent client_Reports = new Intent(ChecklistTypes.this, Tab_Main.class);
            startActivity(client_Reports);
        } else if (id == R.id.emp_reports) {
            Intent emp_reports = new Intent(ChecklistTypes.this, EmployeeReportActivity.class);
            startActivity(emp_reports);
        } else if (id == R.id.mapaclient) {
            Intent mapaclient = new Intent(ChecklistTypes.this, MapaClientActivity.class);
            startActivity(mapaclient);
        } else if (id == R.id.schedulevisits) {
            Intent schedulevisits = new Intent(ChecklistTypes.this, ScheduleVisits.class);
            startActivity(schedulevisits);
        } else if (id == R.id.epsreports) {
            Intent epsreports = new Intent(ChecklistTypes.this, EPSResultsActivity.class);
            startActivity(epsreports);
        } else if (id == R.id.epostingsheet) {
            Intent epostingsheet = new Intent(ChecklistTypes.this, EPostingSheet.class);
            startActivity(epostingsheet);
        } else if (id == R.id.sendfeedback) {
            Intent sendfeedback = new Intent(ChecklistTypes.this, SendFeedBack.class);
            startActivity(sendfeedback);
        } else if (id == R.id.help) {
            Intent help = new Intent(ChecklistTypes.this, HelpActivity.class);
            startActivity(help);
        } else if (id == R.id.logout) {
            Intent logout = new Intent(ChecklistTypes.this, LogOutActivity.class);
